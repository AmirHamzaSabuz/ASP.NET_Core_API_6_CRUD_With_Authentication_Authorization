using CRUD_Authentication_Authorization.Models;
using Microsoft.EntityFrameworkCore;

namespace CRUD_Authentication_Authorization.DAL
{
    public class ApplicationDbContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            {
                options.UseSqlServer("Data Source = localhost\\SQLEXPRESS01; Initial Catalog = CRUD_Authentication_Authorization_Db; Integrated Security = true;");
            }
        }
